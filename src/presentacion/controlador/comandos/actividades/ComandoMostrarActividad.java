...
public class ComandoMostrarActividad extends Comando {
	...
	public RespuestaComando ejecutar() throws Exception {
		...
		if (actividad != null) {
			respuesta = new RespuestaComando(EventoVista.MOSTRAR_ACTIVIDAD_EXITO, actividad);
		} else {
			respuesta = new RespuestaComando(EventoVista.MOSTRAR_ACTIVIDAD_FALLO, actividad);
		}
		return respuesta;
	}
}
